...
class SampleListener(Leap.Listener):
    ...
    def on_init(self, controller):
        ...
        self.previous_angles = [0,0,0,0,0]
    ...
    def on_exit(self, controller):
        ...
        self.a.servo_write(self.PIN6,70) # Claw2
        self.a.close()
        ...
        # Get the most recent frame and report some basic information
            ...
            for hand in frame.hands:
                ...
                if len(hand.fingers) >= 2:
                    ...
                    r2 = ( (x2-x3)**2 + (y2-y3)**2 + (z2-z3)**2 )**0.5
                    ...
                    print 'Finger Tip Distance1 = ',dist_norm
                    print 'Finger Tip Distance2 = ',dist_norm2
            ...
            CLAW_SERVO2 = abs(90-dist_norm2*70)
            print 'Claw Angle =',CLAW_SERVO
            print 'Claw Angle2 =',CLAW_SERVO2
            
            self.a.servo_write(self.PIN5,int(CLAW_SERVO))
            self.a.servo_write(self.PIN6,int(CLAW_SERVO2))
            ...
            self.previous_angles[4] = CLAW_SERVO2
        else:
